    ...
    <div className="flex flex-col">
      ...
      <section className="relative flex items-center justify-center px-4 sm:px-6 py-16 sm:py-24 overflow-hidden">
        ...
        <motion.div variants={stagger} initial="hidden" animate="show" className="max-w-3xl text-center">
          ...
          <motion.h1 variants={fadeUp} className="text-4xl sm:text-6xl lg:text-7xl font-bold tracking-[-0.03em] leading-[0.95]">
            Discover, trade<br /><span className="text-primary">extraordinary</span> NFTs
          </motion.h1>
          ...
          <motion.div variants={fadeUp} className="mt-8">
            <Button size="lg" onClick={() => navigate('/explore')}>
              <MagnifyingGlass size={18} weight="bold" /> Explore
            </Button>
          </motion.div>
        </motion.div>
      </section>
      ...
      <section className="py-10 sm:py-16">
        ...
        <ChainCarousel label="Flare Network" chain="flare" collections={flareCollections} loading={loading} />
        <div className="mt-10">
          <ChainCarousel label="Songbird Network" chain="songbird" collections={songbirdCollections} loading={loading} />
        </div>
      </section>
    </div>
  )
    ...
    <div>
      <div className="container mx-auto px-4 sm:px-6">
        <div className="flex items-center justify-between mb-4">
          ...
          <Link to={`/explore?chain=${chain}`} className="text-xs text-primary font-medium flex items-center gap-1 hover:gap-2 transition-all">
